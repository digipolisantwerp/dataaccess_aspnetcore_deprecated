...
namespace Toolbox.DataAccess.UnitTests.ConnectionStringTests
{
    public class InstantiationTests
    {
        ...
        {
            var ex = Assert.Throws<ArgumentNullException>(() => new ConnectionString("host", 1234, "db", null, "pwd"));
        ...
        {
            var ex = Assert.Throws<ArgumentException>(() => new ConnectionString("host", 1234, "db", "", "pwd"));
            Assert.Equal("user", ex.ParamName);
        }
        ...
        {
            var ex = Assert.Throws<ArgumentNullException>(() => new ConnectionString("host", 1234, "db", "user", null));
        ...
        {
            var ex = Assert.Throws<ArgumentException>(() => new ConnectionString("host", 1234, "db", "user", ""));
            Assert.Equal("password", ex.ParamName);
        }
